...
HD_PWD='C:/Users/Felipe/Documents/VHDL - Sistemas Digitais/Cap 3/Resister/Resister.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Resister.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Resister.tcl
