...
HD_PWD='C:/Users/Felipe/Documents/VHDL - Sistemas Digitais/Cap 3/Resister/Resister.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Resister.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Resister.tcl -notrace
