...
HD_PWD='C:/Users/Raynara Lima/Documents/Capitulo 1/or8_1_GATE/or8_1_GATE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log or8_1_GATE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source or8_1_GATE.tcl -notrace
