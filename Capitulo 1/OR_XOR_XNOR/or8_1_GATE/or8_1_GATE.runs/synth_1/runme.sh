...
HD_PWD='C:/Users/Raynara Lima/Documents/Capitulo 1/or8_1_GATE/or8_1_GATE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log or8_1_GATE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source or8_1_GATE.tcl
