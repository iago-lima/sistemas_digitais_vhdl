...
HD_PWD='C:/Users/Raynara Lima/Documents/Capitulo 1/or16_GATE/or16_GATE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log or16_GATE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source or16_GATE.tcl -notrace
