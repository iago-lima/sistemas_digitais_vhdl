...
HD_PWD='C:/Users/Raynara Lima/Documents/Capitulo 1/or16_GATE/or16_GATE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log or16_GATE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source or16_GATE.tcl
