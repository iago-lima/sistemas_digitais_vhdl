...
read_vhdl -library xil_defaultlib {{C:/Users/Raynara Lima/Documents/Capitulo 1/xor_GATE/xor_GATE.srcs/sources_1/new/xor_GATE.vhd}}
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}

synth_design -top xor_GATE -part xc7z010clg400-1


write_checkpoint -force -noxdef xor_GATE.dcp

catch { report_utilization -file xor_GATE_utilization_synth.rpt -pb xor_GATE_utilization_synth.pb }
