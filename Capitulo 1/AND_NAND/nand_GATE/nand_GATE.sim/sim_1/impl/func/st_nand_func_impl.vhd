...
--               1/nand_GATE/nand_GATE.sim/sim_1/impl/func/st_nand_func_impl.vhd}
-- Design      : nand_GATE
...
entity nand_GATE is
  ...
  attribute NotValidForBitStream of nand_GATE : entity is true;
  attribute ECO_CHECKSUM : string;
  attribute ECO_CHECKSUM of nand_GATE : entity is "2ab6f263";
end nand_GATE;
...
x_OBUF_inst_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
