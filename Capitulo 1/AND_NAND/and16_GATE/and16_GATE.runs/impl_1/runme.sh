...
HD_PWD='C:/Users/Raynara Lima/Documents/Capitulo 1/and16_GATE/and16_GATE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and16_GATE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and16_GATE.tcl -notrace
