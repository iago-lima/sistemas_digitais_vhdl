...
HD_PWD='C:/Users/Raynara Lima/Documents/Capitulo 1/and16_GATE/and16_GATE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and16_GATE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and16_GATE.tcl
