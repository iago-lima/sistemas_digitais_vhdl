...
HD_PWD='C:/Users/Raynara Lima/Documents/Capitulo 1/not16_GATE/not16_GATE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log not16_GATE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source not16_GATE.tcl -notrace
