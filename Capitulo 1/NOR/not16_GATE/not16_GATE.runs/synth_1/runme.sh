...
HD_PWD='C:/Users/Raynara Lima/Documents/Capitulo 1/not16_GATE/not16_GATE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log not16_GATE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source not16_GATE.tcl
